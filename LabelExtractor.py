...
class COCO2YOLO:
    def __init__(self,json_path,ouptut_path):
        self.json_file = json_path;
        self.output = ouptut_path
...
if __name__ == '__main__':
    json_path = "D:/2nd Semester/Vehicle Testing and Validation/FLIR_ADAS_v2/images_thermal_train/coco.json"
    "D:/2nd Semester/Vehicle Testing and Validation/FLIR_ADAS_v2/images_thermal_train/data"
    output_path = "D:/2nd Semester/Vehicle Testing and Validation/FLIR_ADAS_v2/images_thermal_train/data"
    c2y = COCO2YOLO(json_path,output_path)
    c2y.coco2yolo()